  ...
  <head>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $("#Create_a_Notice_button").click(function()){
          $("#main_content").load('Create_a_Notice.php');
        });
      });
    </script>
  </head>
    ...
    <section id="container">
      <div class="row">
        <div class="col-md-2" id="left_sidebar">
          ...
          <button type="button" class="btn btn-primary btn-block" id="View_Replies_button">View Replies</button>
